...
module.exports = {
  get: (accountId, environmentToken, config = {}) => {
    if (!accountId || !environmentToken) {
      console.error('AccountId and EnvironmentToken are required for fetching account settings. Aborting!');
      return;
    }
