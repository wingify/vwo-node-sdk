...
let BucketingService = {
   ...
   */
  _getBucketValueForUser: (userId, disableLog) => {
  ...
  isUserPartOfCampaign: (userId, campaign, disableLog = false) => {
    ...
    let valueAssignedToUser = BucketingService._getBucketValueForUser(userId, disableLog);
  ...
  bucketUserToVariation: (userId, campaign) => {
    ...
    const hashValue = BucketingService._generateHashValue(userId);
  ...
  calculateBucketValue: (userId, multiplier = 1) => {
    const hashValue = BucketingService._generateHashValue(userId);
