...
function activate(vwoInstance, campaignKey, userId) {
  ...
  var settingsFile = vwoInstance.SettingsFileManager.getSettingsFile(); // If no settings are found, simply log and return no variation
...
function track(vwoInstance, campaignKey, userId, goalIdentifier) {
  ...
  var config = vwoInstance.SettingsFileManager.getConfig();
  var settingsFile = vwoInstance.SettingsFileManager.getSettingsFile(); // If no settings are found, simply log and do not track goal
