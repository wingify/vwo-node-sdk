...
const APIMEthodArgumentsValidationEnum = {
  ...
  [Constants.API_METHODS.TRACK]: function(campaignTestKey, userId, goalId) {
    return [
      {
        key: 'campaignTestKey',
        value: campaignTestKey,
...
const ValidateUtil = {
  ...
  areValidParamsForAPIMethod: (method, campaignTestKey, userId, goalId) => {
    let isValid = false;
    let args = APIMEthodArgumentsValidationEnum[method](campaignTestKey, userId, goalId);
