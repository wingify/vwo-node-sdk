...
class VWO {
  ...
  getVariation(campaignTestKey, userId, isCalledViaActivate) {
    ...
    let { variationName, variationId } = VariationDecider.getVariationAllotted(settingsFile, campaignTestKey, userId);
  ...
  track(campaignTestKey, userId, goalIdentifier, revenue) {
    ...
    let { variationId, variationName } = VariationDecider.getVariationAllotted(settingsFile, campaignTestKey, userId);
  ...
  __getStoredVariation(config, campaignTestKey, userId, campaignBucketMap = {}) {
    if (campaignBucketMap.hasOwnProperty(campaignTestKey)) {
      ...
      let variationId = decision.variationName;
