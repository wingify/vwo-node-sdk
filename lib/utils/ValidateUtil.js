...
const APIMethodArgumentsValidationEnum = {
  [ApiEnum.ACTIVATE]: function({ campaignKey, userId, customVariables = {} }) {
    return [
      {
        key: 'campaignKey',
        value: campaignKey,
  ...
  [ApiEnum.TRACK]: function({ campaignKey, userId, goalIdentifier, customVariables = {} }) {
    return [
      {
        key: 'campaignKey',
        value: campaignKey,
  ...
  [ApiEnum.IS_FEATURE_ENABLED]: function({ campaignKey, userId, customVariables = {} }) {
    return [
      {
        key: 'campaignKey',
        value: campaignKey,
  ...
  [ApiEnum.GET_FEATURE_VARIABLE_VALUE]: function({ campaignKey, variableKey, userId, customVariables = {} }) {
    return [
      {
        key: 'campaignKey',
        value: campaignKey,
...
const ValidateUtil = {
  ...
  areValidParamsForAPIMethod: ({
    ...
    let isValid = false;
    let args = APIMethodArgumentsValidationEnum[method]({
      campaignKey,
      userId,
      goalIdentifier,
      customVariables,
